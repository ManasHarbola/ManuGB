...
CPU.o : $(SRC)/cpu/CPU.cpp
	g++ $(VERSION) -c -g $(SRC)/cpu/CPU.cpp -o $(BUILD_DIR)/CPU.o

InstructionHandler.o : $(SRC)/cpu/InstructionHandler.cpp
	g++ $(VERSION) -c -g $(SRC)/cpu/InstructionHandler.cpp -o $(BUILD_DIR)/InstructionHandler.o

InterruptManager.o : $(SRC)/cpu/InterruptManager.cpp
	g++ $(VERSION) -c -g $(SRC)/cpu/InterruptManager.cpp -o $(BUILD_DIR)/InterruptManager.o

MMU.o : $(SRC)/mmu/MMU.cpp
	g++ $(VERSION) -c -g $(SRC)/mmu/MMU.cpp -o $(BUILD_DIR)/MMU.o

PPU.o : $(SRC)/ppu/PPU.cpp
	g++ $(VERSION) -c -g $(SRC)/ppu/PPU.cpp -o $(BUILD_DIR)/PPU.o

Timer.o : $(SRC)/timer/Timer.cpp
	g++ $(VERSION) -c -g $(SRC)/timer/Timer.cpp -o $(BUILD_DIR)/Timer.o

GameBoy.o : $(SRC)/GameBoy.cpp
	g++ $(VERSION) -c -g $(SRC)/GameBoy.cpp -I $(INCLUDE) -o $(BUILD_DIR)/GameBoy.o

Main.o : $(SRC)/Main.cpp
	g++ $(VERSION) -c -g $(SRC)/Main.cpp -I $(INCLUDE) -o $(BUILD_DIR)/Main.o

...
//Green Palette
/*
constexpr RGBA32 LIGHTEST(0x9B, 0xBC, 0x0F, 0xFF), LIGHT(0x8B, 0xAC, 0x0F, 0xFF),
                 DARK(0x30, 0x62, 0x30, 0xFF), DARKEST(0x0F, 0x38, 0x0F, 0xFF);
*/
...
//test palette
constexpr RGBA32 LIGHTEST(0xFF, 0xFF, 0xFF, 0xFF), LIGHT(0xAA, 0xAA, 0xAA, 0xFF),
                 DARK(0x55, 0x55, 0x55, 0xFF), DARKEST(0x00, 0x00, 0x00, 0xFF);
